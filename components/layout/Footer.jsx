...
export default function Footer() {
  ...
  return (
    <footer className="w-full max-w-2xl mx-auto px-6 py-16 border-t border-[var(--border-subtle)] transition-colors duration-300">
      ...
      {/* Bottom Row */}
      <div className="mt-12 pt-6 border-t border-[var(--border-subtle)] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 text-xs text-[var(--text-muted)] font-mono">
